...
static const SfallContentMapping kSfallContentMappings[] = {
    ...
    { "Misc", "StartGDialogFix", CONTENT_CONFIG_DIALOG_SECTION, "start_gdialog_fix" },
    ...
    { "Sound", "MainMenuMusic", CONTENT_CONFIG_SOUND_SECTION, "main_menu_music" },
    { "Sound", "WorldMapMusic", CONTENT_CONFIG_SOUND_SECTION, "worldmap_music" },
    { "Sound", "WorldMapCarMusic", CONTENT_CONFIG_SOUND_SECTION, "worldmap_car_music" },
    { "Sound", "EndGameMovieMusic0", CONTENT_CONFIG_SOUND_SECTION, "endgame_movie_music0" },
    { "Sound", "EndGameMovieMusic1", CONTENT_CONFIG_SOUND_SECTION, "endgame_movie_music1" },
    { "Sound", "MapLoadingSound", CONTENT_CONFIG_SOUND_SECTION, "map_loading_sound" },
