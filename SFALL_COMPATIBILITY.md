...
| Stats / Alter min/max | get/set_stat_min/max<br>set_pc_stat_min/max<br>set_npc_stat_min/max | implemented: set_stat_max (0x81B4), set_stat_min (0x81B5), get_stat_max, get_stat_min | get_stat_max/get_stat_min implemented (sfall_metarules.cc:2095,2111). set_pc_stat_min/max and set_npc_stat_min/max are sfall aliases not yet implemented. |
